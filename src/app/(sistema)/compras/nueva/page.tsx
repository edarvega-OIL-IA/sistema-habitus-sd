...
export default function ComprasNuevaPage() {
    ...
    try {
      ...
      const { data: orden, error: ordenError } = await supabase
        ...
        .insert({
          ...
          numero_factura_proveedor: tieneComprobante ? nroFactura.trim() || null : null,
          numero_remito_proveedor: tieneComprobante ? nroRemito.trim() || null : null,
      ...
      // Marcar como visible en salón todo artículo que se carga en una orden
      // de compra, sin importar si queda en Borrador o se confirma — así no
      // hace falta ir a activarlo a mano en Artículos después de cada pedido.
  ...
  // no tiene escala fija), pero en pantalla se redondea a 3 decimales para
  // que no se vea "7,69230769..." — mismo criterio que fmtInput con precio.
